...
(*[ https://gitlab.com/matchete/matchete/-/commit/30785e37996b12896a8fd3601839ec047976cfd0 ]*)
...
\[ScriptCapitalL]MSSM = LoadModel[FileNameJoin[{NotebookDirectory[], "_MSSM_v2.m"}], ModelParameters->{\[Mu]t->\[Mu]}]


(* ::Subsection:: *)
(*Restricting to right-handed up-type squarks + Bino*)


\[ScriptCapitalL]MSSM = \[ScriptCapitalL]MSSM/.{Field[Alternatives@@{\[CapitalSigma],\[CapitalPhi],lt,et,dt,Gt,Wt,qt,Hut,Hdt},___]->0};
...
Print["One Loop Operators Off-Shell:"];
Print@Format[Simplify[Coefficient[\[ScriptCapitalL]EFT$OneLoop/.{Field[Alternatives@@{l,q,d,H,e},___]->0},Coupling[g1,{},0],4]], NiceForm]
Print[" "];
...
Print@Format[Collect[\[ScriptCapitalL]EFT$OffShell/.{Field[Alternatives@@{l,q,d,H,e},___]->0},{\[Epsilon],Coupling[g3,{},0],Coupling[g1,{},0]},Simplify], NiceForm]
...
Print["One Loop Operators On-Shell:"];
Print@Format[Simplify[Coefficient[\[ScriptCapitalL]EFT$OnShell/.{Field[Alternatives@@{l,q,d,H,e},___]->0},Coupling[g1,{},0],4]], NiceForm]
Print[" "];
...
Print["One Loop Operators Green:"];
Print@Format[Simplify[Coefficient[\[ScriptCapitalL]EFT$OnShell/.{Field[Alternatives@@{l,q,d,\[Phi],e},___]->0},Coupling[g1,{},0],4]], NiceForm]
Print[" "];
...
Export[FileNameJoin[{"results","StopR-EFT-Lagrangian_on-shell.m"}], \[ScriptCapitalL]EFT$OnShell$replaced];
Export[FileNameJoin[{"results","StopR-EFT-Lagrangian_on-shell-eff.m"}], \[ScriptCapitalL]EFT$OnShell];
...
Export[FileNameJoin[{"results","StopR-matching-conditions.m"}],MatchingCondition];
